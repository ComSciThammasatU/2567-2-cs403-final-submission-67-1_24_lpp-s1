...
class Error403RouteBuilder extends WorkspaceViewScreenRouteBuilder {
    public getScreenId(): string {
        return "screen.web.system.error.403";
    }
    ...
    public getRoutePath(): string {
        return WorkSpaceLayoutRoute.getRoutePath() + "/error/403";
    }

    public getComponent() {
        return () => import('@/app/ui/views/workspace/error/Error403View.vue');
    }
...
namespace Error403Route {
    const builder = new Error403RouteBuilder();
