...
@APIController
@RequestMapping("/api/core/student/setup/load-screen")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class StudentSetupLoadScreenAPI extends AbstractJsonBodyAPI<StudentSetupLoadScreenAPI.RequestMessage, StudentSetupLoadScreenAPI.BodyResponseMessage>
{
	@Autowired
