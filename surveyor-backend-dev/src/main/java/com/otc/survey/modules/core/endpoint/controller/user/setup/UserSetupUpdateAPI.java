...
@APIController
@RequestMapping("/api/core/user/setup/update")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class UserSetupUpdateAPI extends AbstractJsonBodyAPI<UserSetupUpdateAPI.RequestMessage, UserSetupUpdateAPI.BodyResponseMessage>
{
	@Override
