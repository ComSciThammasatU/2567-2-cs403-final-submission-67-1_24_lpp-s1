...
@APIController
@RequestMapping("/api/core/user/setup/load-screen")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class UserSetupLoadScreenAPI extends AbstractJsonBodyAPI<UserSetupLoadScreenAPI.RequestMessage, UserSetupLoadScreenAPI.BodyResponseMessage>
{
	@Override
