package com.otc.survey.modules.common.domain.util;
...
public class JsonUtil 
{
	...
	public static <T> T parse(String jsonString, TypeReference<T> valueTypeRef) throws JsonMappingException, JsonProcessingException
	{
		ObjectMapper objectMapper = new ObjectMapper();
