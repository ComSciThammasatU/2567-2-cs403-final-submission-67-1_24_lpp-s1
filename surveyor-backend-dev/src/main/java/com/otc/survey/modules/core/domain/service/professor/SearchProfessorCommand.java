...
@ServiceCommand
public class SearchProfessorCommand extends BaseServiceCommand 
{	
	@Autowired
	...
	public Response searchProfessor(Request request)
	{
		...
		List<ProfessorInfo> professorInfos = users
				.stream()
				.map(user -> {
					ProfessorInfo professorInfo = new ProfessorInfo();
					professorInfo.setUser(user);
					professorInfo.setRoles(getRolesByUser(roles, userRoleMappers, user));
					professorInfo.setUserGroups(getUserGroupsByUser(userGroups, userGroupMappers, user));
		...
		searchProfessorResponse.setProfessorInfos(professorInfos);
		
		Response response = new Response();
		response.setSearchProfessorResponse(searchProfessorResponse);
