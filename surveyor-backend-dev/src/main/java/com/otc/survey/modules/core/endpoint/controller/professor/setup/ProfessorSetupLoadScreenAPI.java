...
@APIController
@RequestMapping("/api/core/professor/setup/load-screen")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class ProfessorSetupLoadScreenAPI extends AbstractJsonBodyAPI<ProfessorSetupLoadScreenAPI.RequestMessage, ProfessorSetupLoadScreenAPI.BodyResponseMessage> 
{
	@Autowired
