...
@APIController
@RequestMapping("/api/core/user/setup/search")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class UserSetupSearchAPI extends AbstractJsonBodyAPI<UserSetupSearchAPI.RequestMessage, UserSetupSearchAPI.BodyResponseMessage>
{
	@Override
