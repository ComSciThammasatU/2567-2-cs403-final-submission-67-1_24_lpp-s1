...
@APIController
@RequestMapping("/api/survey/form-document/user/load-screen")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class FormDocumentUserLoadScreenAPI extends AbstractJsonBodyAPI<FormDocumentUserLoadScreenAPI.RequestMessage, FormDocumentUserLoadScreenAPI.BodyResponseMessage>
{
	@Override
