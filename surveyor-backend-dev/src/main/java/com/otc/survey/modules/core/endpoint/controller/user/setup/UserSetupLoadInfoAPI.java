...
@APIController
@RequestMapping("/api/core/user/setup/load-info")
@Auth(
	authen = true,
	authorize = true,
	grantedRoleIds = {
...
public class UserSetupLoadInfoAPI extends AbstractJsonBodyAPI<UserSetupLoadInfoAPI.RequestMessage, UserSetupLoadInfoAPI.BodyResponseMessage>
{
	@Override
